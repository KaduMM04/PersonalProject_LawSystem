...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String...args) throws Exception {
		...
		Lawyer l1 = new Lawyer("Dirlei", "dirlei@email", passwordEncoder.encode("123"), UserRole.ADMIN, 2444L, "Civil");
		Lawyer l2 = new Lawyer("Priscilla", "priscilla@email", passwordEncoder.encode("123"), UserRole.ADMIN, 3214L, "Previdenciario");
		...
		UserLogin u1 = new UserLogin(l1.getEmail(), l1.getPassword(), l1.getRole());
		UserLogin u2 = new UserLogin(l2.getEmail(), l2.getPassword(), l2.getRole());
		
		UserLogin u3 = new UserLogin(cl1.getEmail(), cl1.getPassword(), cl1.getRole());
		UserLogin u4 = new UserLogin(cl2.getEmail(), cl2.getPassword(), cl2.getRole());
		UserLogin u5 = new UserLogin(cl3.getEmail(), cl3.getPassword(), cl3.getRole());
